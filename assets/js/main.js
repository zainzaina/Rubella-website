...
document.addEventListener('DOMContentLoaded',()=>{initPreloader();updateCartCount();renderCart();setupReveal();setupPills();setupBrandLogo();renderShopProducts();initProductPage();setupShopFilters();initHeaderOverlays();});
